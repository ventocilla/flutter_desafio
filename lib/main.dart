  ...
  Widget build(BuildContext context) {
    return Container(
      child: ListView.builder(
        ...
        itemBuilder: (_, index) {
          return RevendaCard(
            marca: revendas[index].marca,
            nome: revendas[index].nome,
            nota: revendas[index].caracteristicas['nota'],
            tempo: revendas[index].caracteristicas['tempo'],
            preco: revendas[index].caracteristicas['preco'],
            color: revendas[index].color,
          );
        },
      ),
    );
